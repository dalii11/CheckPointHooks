...
import MyNavBar from "./Companents/MyNavBar/MyNavBar";

import AddMovie from "./Companents/AddMovie/AddMovie";
...
function App() {
    ...
    const [reateSearch, setReateSearch] = useState(0);
    const getRateSearch = (inputRate) => {
        setReateSearch(inputRate);
    };
